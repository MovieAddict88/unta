      ...
      <title>ConeCraze</title>
      <!-- PWA Meta Tags -->
      <meta name="theme-color" content="#141414">
      <meta name="apple-mobile-web-app-capable" content="yes">
      <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
      <meta name="apple-mobile-web-app-title" content="ConeCraze">
      <meta name="description" content="Watch movies and TV shows anytime, anywhere. Stream unlimited entertainment on all your devices.">
      <!-- PWA Manifest -->
      <link rel="manifest" href="manifest.webmanifest">
      <link rel="apple-touch-icon" href="https://movie-fcs.fwh.is/cinecraze/cinecraze.png">
      <link rel="icon" type="image/png" href="https://movie-fcs.fwh.is/cinecraze/cinecraze.png" sizes="512x512">
      ...
      <style>
       ...
       /* Notification Bar Styles */
        ...
        :root {
            ...
            /* Backwards-compat variables used throughout the existing UI */
            --youtube-red: var(--netflix-red);
            --youtube-dark: var(--netflix-black);
            --youtube-gray: var(--netflix-gray);
            --youtube-light-gray: var(--netflix-light-gray);
        ...
        * {
            ...
            font-family: 'Netflix Sans', 'Helvetica Neue', 'Segoe UI', Roboto, Arial, sans-serif;
        }
        ...
        /* Focus styles for TV remotes and keyboard navigation */
        *:focus-visible {
...
.content-card.grid .card-meta .meta-country .fi {
    ...
    font-size: 18px; /* Default for desktop grid and list, and larger mobile list */
        ...
        .card-img.has-trailer {
            overflow: hidden;
        }

        .card-img.has-trailer img {
            transition: opacity 0.5s ease;
        }

        /* Poster fades when trailer is playing */
        .card-img.has-trailer.trailer-playing img {
            opacity: 0;
            pointer-events: none;
        }
        ...
        .content-card.grid .card-img:hover .trailer-overlay,
        .content-card.list .card-img:hover .trailer-overlay {
            opacity: 1;
        }

        /* Show overlay when trailer is playing */
        .card-img.has-trailer.trailer-playing .trailer-overlay {
            opacity: 1;
        }
        ...
        /* Show video container when trailer is playing */
        .card-img.has-trailer.trailer-playing .trailer-video-container {
            opacity: 1;
        }
        ...
        /* Hide controls when trailer is playing */
        .card-img.has-trailer.trailer-playing .trailer-controls {
            opacity: 0;
            pointer-events: none;
        }
        ...
        /* Mobile/Touch specific trailer behavior */
        @media (hover: none) and (pointer: coarse) {
            ...
            /* Show overlay only on touch/hover */
            .card-img:active .trailer-overlay,
            .card-img.trailer-touching .trailer-overlay {
                opacity: 1;
                background: rgba(0, 0, 0, 0.3);
            }

            /* Always show overlay when playing */
            .card-img.has-trailer.trailer-playing .trailer-overlay {
                opacity: 1;
                background: transparent;
            }
        ...
        .trailer-iframe:not([src]) {
            background: linear-gradient(45deg, var(--youtube-dark-gray), var(--youtube-gray));
    ...
    .back-button {
        ...
        */
        ...
        :root {
            ...
            --page-pad: clamp(12px, 4vw, 90px);
            --page-pad-y: clamp(12px, 2.5vw, 40px);
            --header-height: clamp(56px, 7vh, 92px);
            --footer-height: clamp(96px, 10vh, 160px);
            --bottom-nav-height: clamp(56px, 8vh, 86px);
            --ui-gap: clamp(10px, 1.8vw, 22px);
            --control-size: clamp(36px, 3.2vw, 54px);
            --grid-card-min: clamp(130px, 16vw, 260px);
            --grid-gap: clamp(12px, 2vw, 28px);
            --base-font-size: clamp(14px, 1.15vw, 18px);
        }
        ...
        header {
            padding: clamp(10px, 1.4vw, 18px) max(var(--page-pad), calc((100vw - var(--content-max-width)) / 2));
            gap: var(--ui-gap);
        ...
        .search-container {
            width: min(clamp(180px, 42vw, 620px), 100%);
        }
        ...
        .carousel {
            margin: 0 max(var(--page-pad), calc((100vw - var(--content-max-width)) / 2)) clamp(18px, 2vw, 34px);
        ...
        .filters-section {
            padding: 0 max(var(--page-pad), calc((100vw - var(--content-max-width)) / 2));
        }
        ...
        .content-container {
            padding: 0 max(var(--page-pad), calc((100vw - var(--content-max-width)) / 2)) clamp(40px, 6vw, 100px);
        }
        ...
        .bottom-nav {
            ...
            padding-inline: max(var(--page-pad), calc((100vw - var(--content-max-width)) / 2));
        }
        ...
        @media (max-width: 768px) {
            ...
            .content-container {
                padding-bottom: calc(clamp(40px, 6vw, 100px) + var(--bottom-nav-height) + env(safe-area-inset-bottom));
            }
        }
        ...
        @media (min-width: 1600px) {
            :root {
                --grid-card-min: clamp(220px, 13vw, 320px);
                --base-font-size: clamp(16px, 0.8vw, 20px);
            }
        }
        ...
        /* ===== Netflix-Style Enhanced Responsive Design ===== */
        
        /* Extra Small Devices (4-inch smartphones and up - 320px to 480px) */
        @media (max-width: 480px) {
            .splash-logo {
                font-size: 48px;
                letter-spacing: 4px;
        ...
        /* Tablets (Landscape) and Small Laptops - 769px to 1024px */
        ...
        /* Large Desktop and HD Screens - 1440px to 1919px */
        ...
        /* Full HD, 4K, and TV Screens - 1920px and up */
        @media (min-width: 1920px) {
            .splash-logo {
                font-size: 120px;
                letter-spacing: 10px;
        ...
        /* 4K and 8K TV Screens - 2560px and up */
        ...
        /* Android TV Box and Smart TV Specific Optimizations */
        @media (hover: none) and (pointer: coarse) {
            ...
            .content-card:focus {
                transform: scale(1.05);
                box-shadow: 0 0 0 4px var(--netflix-red);
                z-index: 10;
            }
        ...
        /* Landscape orientation for phones and tablets */
...
<body>
    ...
    <div class="splash-screen" id="splash-screen">
        <div class="splash-logo">CONECRAZE</div>
    </div>
    ...
    <!-- Header -->
    <header>
        <a href="#" class="logo" aria-label="ConeCraze Home">
            <img src="https://movie-fcs.fwh.is/cinecraze/cinecraze.png" alt="ConeCraze Logo">
            <span>ConeCraze</span>
        </a>
...
<a href="https://youtube.com/@ronaldtorrejos?si=z1du-MZnP6OyUmlf" target="_blank"><i class="fab fa-youtube"></i></a>
  ...
  <i class="fas fa-phone"></i> +639663016917
        ...
        <div class="footer-bottom">
            &copy; 2025 ConeCraze. All Rights Reserved.
        </div>
    </footer>
    ...
    <script>
        // ===== Netflix-Style Splash Screen Handler =====
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Hide splash after animation completes (3.8 seconds total)
            setTimeout(() => {
                splashScreen.classList.add('hidden');
        ...
        const CACHE_META_KEY = 'cacheMeta';
        const TAB_CACHE_KEY = 'tabCache';
        ...
        async function init() {
            ...
            let initialCategory = localStorage.getItem(ACTIVE_CATEGORY_KEY) || 'all';
            const allowedCategories = new Set(['all', 'movies', 'series', 'live']);
            if (!allowedCategories.has(initialCategory)) {
                initialCategory = 'all';
            }

            const navItems = document.querySelectorAll('.nav-item');
            navItems.forEach(nav => nav.classList.toggle('active', nav.dataset.category === initialCategory));
            await renderContent(initialCategory);
        ...
        function buildTabContentCacheFromCineData(data) {
            const cache = { movies: [], series: [], live: [] };
            if (!data || !Array.isArray(data.Categories)) return cache;

            data.Categories.forEach(cat => {
                const name = cat && cat.MainCategory ? String(cat.MainCategory).toLowerCase() : '';
                const type = name.includes('series') ? 'series' :
                    name.includes('live') ? 'live' : 'movie';

                (cat.Entries || []).forEach(entry => {
                    const normalized = { ...entry, type };
                    if (type === 'movie') cache.movies.push(normalized);
                    else if (type === 'series') cache.series.push(normalized);
                    else cache.live.push(normalized);
                });
            });
        ...
        function withAllTabCache(tabCache) {
            const movies = tabCache && Array.isArray(tabCache.movies) ? tabCache.movies : [];
            const series = tabCache && Array.isArray(tabCache.series) ? tabCache.series : [];
            const live = tabCache && Array.isArray(tabCache.live) ? tabCache.live : [];

            return {
                movies,
                series,
                live,
                all: movies.concat(series, live)
            };
        }

        function showFatalDataLoadError(err) {
        ...
        async function fetchServerContentVersion() {
            try {
                const response = await fetch('api.php?action=get_content_version', { cache: 'no-store' });
                if (!response.ok) {
                    return null;
                }
                const data = await response.json();
                if (!data || data.error || !data.version) {
                    return null;
                }
                return String(data.version);
            } catch (err) {
                console.warn('Failed to fetch server content version:', err);
                return null;
            }
        }

        async function readCineDataFromIndexedDB() {
            try {
                const db = await dbUtil.open();
                const [data, meta, tabCache] = await Promise.all([
                    dbUtil.get(db, PLAYLIST_KEY),
                    dbUtil.get(db, CACHE_META_KEY),
                    dbUtil.get(db, TAB_CACHE_KEY)
                ]);
                db.close();
                return { data, meta, tabCache };
            } catch (err) {
                return { data: null, meta: null, tabCache: null };
            }
        }

        async function writeCineDataToIndexedDB({ data, version, tabCache }) {
            try {
                const db = await dbUtil.open();

                await dbUtil.set(db, PLAYLIST_KEY, data);

                const meta = {
                    version: version || null,
                    cachedAt: Date.now()
                };
                await dbUtil.set(db, CACHE_META_KEY, meta);

                if (tabCache) {
                    await dbUtil.set(db, TAB_CACHE_KEY, {
                        movies: Array.isArray(tabCache.movies) ? tabCache.movies : [],
                        series: Array.isArray(tabCache.series) ? tabCache.series : [],
                        live: Array.isArray(tabCache.live) ? tabCache.live : []
                    });
                }
                ...
                if (version) {
                    try {
                        localStorage.setItem(CACHE_VERSION_LS_KEY, String(version));
                    } catch (e) {
                        // Ignore localStorage errors (disabled/private mode)
                    }
                }
            } catch (err) {
                console.warn('Could not cache data to IndexedDB', err);
            }
        }
        ...
        async function applyUpdatedDataToUI() {
            ...
            if (elements.viewerPage && elements.viewerPage.style.display === 'block') {
                return;
            }

            const currentFilters = {
                genre: elements.genreFilter ? elements.genreFilter.value : null,
                country: elements.countryFilter ? elements.countryFilter.value : null,
                year: elements.yearFilter ? elements.yearFilter.value : null,
                sort: elements.sortFilter ? elements.sortFilter.value : null
            };
            ...
            restoreSelectValue(elements.genreFilter, currentFilters.genre);
            restoreSelectValue(elements.countryFilter, currentFilters.country);
            restoreSelectValue(elements.yearFilter, currentFilters.year);
            restoreSelectValue(elements.sortFilter, currentFilters.sort);

            updateCarousel();

            const activeNavItem = document.querySelector('.nav-item.active');
            const category = activeNavItem ? activeNavItem.dataset.category : (localStorage.getItem(ACTIVE_CATEGORY_KEY) || 'all');
            await renderContent(category);
        }

        async function checkForUpdatesAndRefresh({ silent = true } = {}) {
            const serverVersion = await fetchServerContentVersion();
            if (!serverVersion) {
                return;
            }
            ...
            const cachedVersion = (cacheMeta && cacheMeta.version) ? String(cacheMeta.version) : (storedVersion ? String(storedVersion) : null);

            if (cachedVersion && cachedVersion === String(serverVersion)) {
                if (!cacheMeta || cacheMeta.version !== serverVersion) {
                    cacheMeta = { version: String(serverVersion), cachedAt: Date.now() };
                    try {
                        const db = await dbUtil.open();
                ...
                try {
                    localStorage.setItem(CACHE_VERSION_LS_KEY, String(serverVersion));
                } catch (e) {
                    // Ignore
                }
            ...
            try {
                const data = await fetchAllContentFromServer({ showSpinner: !silent });
                cineData = data;
        ...
        function renderContentFilters() {
            ...
            const clearOptionsExceptFirst = (selectEl) => {
                if (!selectEl) return;
            ...
            clearOptionsExceptFirst(elements.genreFilter);
            clearOptionsExceptFirst(elements.countryFilter);
            clearOptionsExceptFirst(elements.yearFilter);
        ...
        function createContentCard(item, viewType) {
            ...
            const hasTrailer = item.Trailer && item.Trailer.url;
            const trailerClass = hasTrailer ? 'has-trailer' : '';

            card.innerHTML = `
                <div class="card-img ${trailerClass}">
                    ...
                    ${hasTrailer ? `
                        <div class="trailer-overlay">
                            <div class="trailer-video-container">
                                <iframe class="trailer-iframe" data-src="${item.Trailer.url}?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&modestbranding=1" 
                ...
                relatedContent.forEach(item => { /* ... render related card ... */ 
                    ...
                    card.innerHTML = `
                        ...
                        <div class="related-info">
                            ...
                            <div class="related-channel">ConeCraze</div>
                        </div>
                    `;
                    card.addEventListener('click', () => openViewer(item));
        ...
        function getAutoplayUrl(url) {
            ...
            // Don't add autoplay parameter if YouTube embed URL already has it
        ...
        async function playUrl(url, servers = []) {
            ...
            const isEmbed = isYouTubeUrl(url) || isGoogleDriveUrl(url) || isMegaNzUrl(url) || isVidsrcUrl(url) || isVidjoyUrl(url) || isVidsrcMeUrl(url) || isVidsrcToUrl(url) || isVidsrcXyzUrl(url) || isGoDrivePlayerUrl(url) || isVidLinkProUrl(url) || is2EmbedUrl(url) || isEmbedSuUrl(url) || isAutoEmbedUrl(url) || isVideasyUrl(url) || isVidfastEmbedUrl(url) || isVidplusUrl(url);
            ...
            if (isEmbed) {
                ...
                // Add iframe onload handler for proper initialization
                ...
                // Set iframe source immediately after it's properly initialized
...
function playYouTubeVideo(url) {
    ...
    if (!videoId) {
        ...
        playerContainer.innerHTML = '<p>Error: Invalid YouTube URL</p>';
        return;
    }
    const embedUrl = `https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0&modestbranding=1&iv_load_policy=3&showinfo=0&disablekb=1`;
    ...
    // 2. Set the src in the next animation frame
...
async function switchToServer(server, allServers) {
    try {
        ...
        if (isEmbed) {
            ...
            if (isYouTubeUrl(server.url)) {
                const videoId = extractYouTubeId(server.url);
                if (videoId) embedUrl = `https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0&modestbranding=1`;
            } else if (isGoogleDriveUrl(server.url)) {
            ...
            // Set iframe source after it's properly initialized
            setTimeout(() => {
                iframe.src = getAutoplayUrl(embedUrl);
            }, 100);
        ...
        function createEmbeddedServerSelector(servers) {
            ...
            servers.forEach((server, index) => {
                ...
                // Add click handler to switch servers
                serverItem.addEventListener('click', () => {
                    // Normalize URLs for comparison (remove autoplay parameters)
                    const normalizeUrl = (url) => {
                        if (!url) return '';
                        return url.split('?')[0] + (url.includes('autoplay=') ? '?' + url.split('?')[1].replace(/&?autoplay=[^&]*/g, '').replace(/&$/, '') : '');
                    };
                    
                    const currentSrc = normalizeUrl(iframe?.src);
                    const targetUrl = normalizeUrl(server.url);
                    
                    if (currentSrc !== targetUrl) {
                        // Update iframe source with proper conversion
                        if (iframe) {
                            ...
                            // Convert URL properly for YouTube
                            let embedUrl = server.url;
                            if (isYouTubeUrl(server.url)) {
                                const videoId = extractYouTubeId(server.url);
                                if (videoId) {
        ...
        async function updatePlayerSource(servers) {
            ...
            if (servers && servers.length > 0) {
                ...
                if (optimalServer) {
                    ...
                    if (isYouTubeUrl(optimalServer.url) || isVidsrcUrl(optimalServer.url) || isVidjoyUrl(optimalServer.url) || isVidsrcMeUrl(optimalServer.url) || isVidsrcToUrl(optimalServer.url) || isVidsrcXyzUrl(optimalServer.url) || isGoDrivePlayerUrl(optimalServer.url) || isVidLinkProUrl(optimalServer.url) || is2EmbedUrl(optimalServer.url) || isEmbedSuUrl(optimalServer.url) || isAutoEmbedUrl(optimalServer.url) || isVideasyUrl(optimalServer.url) || isMegaNzUrl(optimalServer.url) || isGoogleDriveUrl(optimalServer.url)) {
        ...
        // --- Enhanced Trailer Playback Logic ---
        let activeTrailerCard = null; // Tracks the card with the currently playing trailer

        // Custom event to notify other cards to stop their trailers
        const stopTrailerEvent = new Event('stopAllTrailers');

        function setupTrailerEvents(card, item) {
            const cardImg = card.querySelector('.card-img');
            const trailerIframe = card.querySelector('.trailer-iframe');
            const trailerPlayBtn = card.querySelector('.trailer-play-btn');

            if (!cardImg || !trailerIframe || !trailerPlayBtn) return;
            ...
            const stopTrailer = () => {
                ...
                cardImg.classList.remove('trailer-playing', 'trailer-touching');
            ...
            const playTrailer = () => {
                // If another trailer is playing, dispatch an event to stop it
                if (activeTrailerCard && activeTrailerCard !== card) {
                    document.dispatchEvent(stopTrailerEvent);
                }
                
                activeTrailerCard = card;

                if (!isTrailerLoaded && trailerIframe.dataset.src) {
                    trailerIframe.src = trailerIframe.dataset.src;
                    isTrailerLoaded = true;
                }
                cardImg.classList.add('trailer-playing');
            };

            const toggleTrailer = () => {
                if (cardImg.classList.contains('trailer-playing')) {
                    stopTrailer();
                } else {
                    playTrailer();
                }
            ...
            document.addEventListener('stopAllTrailers', () => {
                if (activeTrailerCard !== card) {
                     stopTrailer();
                }
            });

            // Make the card listen to its own stop command (e.g., when another starts)
            card.addEventListener('stopThisTrailer', stopTrailer);


            // Desktop (Mouse) Events
            if (!isTouchDevice) {
                card.addEventListener('mouseenter', () => {
                    hoverTimeout = setTimeout(playTrailer, 800); // Auto-play after 0.8s hover
                });
            ...
            cardImg.addEventListener('touchend', (e) => {
                ...
                // It's a tap if movement is minimal and duration is short
                if (dx < 10 && dy < 10 && dt < 300) {
                     // Prevent card click from firing immediately
                    e.preventDefault();
                    e.stopPropagation();
                    toggleTrailer();
                }
            ...
            // The main card click should only open the viewer if a trailer isn't playing
            card.addEventListener('click', (e) => {
                // If a trailer is playing on this card, the click should stop it.
                if (cardImg.classList.contains('trailer-playing')) {
                    e.preventDefault(); // Prevent viewer from opening
                    e.stopPropagation();
                    stopTrailer();
                }
                // If a trailer is NOT playing, the default behavior (opening the viewer) will proceed.
            }, true); // Use capture phase to decide logic before it bubbles
        }
        ...
        function setupEventListeners() {
            ...
            navItems.forEach(item => {
                item.addEventListener('click', async (e) => {
                    ...
                    if (category === 'all' || category === 'movies' || category === 'series' || category === 'live') {
  ...
  return function(...args) {
    ...
    timeout = setTimeout(later, wait);
        ...
        async function handleShareVideo() {
            ...
            let shareText = `Watch "${currentContentInfo.Title}" on ConeCraze!`;
            ...
            if (currentContentInfo.type === 'series' && currentEpisode && currentEpisode.Title) {
                ...
                shareText = `Watch "${currentSeries.Title} - Episode ${currentEpisode.Episode}: ${currentEpisode.Title}" on ConeCraze!`;
                ...
                shareText = `Check out the series "${currentSeries.Title}" on ConeCraze!`;
            }
...
playerInstance.on('ready', event => {
    addPipButtonToPlayer();
        ...
        function updateInstallButtonVisibility() {
            if (!isAppInstalled() && pwaInstallContainer) {
                // Check if service worker is supported
                if ('serviceWorker' in navigator) {
                    pwaInstallContainer.style.display = 'block';
                }
            } else if (pwaInstallContainer) {
        ...
        window.addEventListener('appinstalled', () => {
            ...
            alert('ConeCraze app has been installed successfully!');
        });
                        ...
                        registration.addEventListener('updatefound', () => {
                            ...
                            newWorker.addEventListener('statechange', () => {
                                if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                                    ...
                                    const confirmUpdate = confirm('A new version of ConeCraze is available! Would you like to update now?');
                                    if (confirmUpdate) {
        ...
        // ===== TV Remote and Keyboard Navigation Support =====
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateFocusableElements() {
                focusableElements = Array.from(document.querySelectorAll(
                    ...
                    'textarea:not([disabled]), .content-card, [tabindex]:not([tabindex="-1"])'
                )).filter(el => {
            ...
            document.addEventListener('keydown', function(e) {
                ...
                switch(e.key) {
                    ...
                    case 'ArrowRight':
                    case 'Right':
                        // For content cards, move to next card in grid
                        if (activeElement.classList.contains('content-card')) {
                            e.preventDefault();
                            const nextCard = activeElement.nextElementSibling;
                    ...
                    case 'ArrowLeft':
                    case 'Left':
                        // For content cards, move to previous card in grid
                        if (activeElement.classList.contains('content-card')) {
                            e.preventDefault();
                            const prevCard = activeElement.previousElementSibling;
                    ...
                    case 'Enter':
                    case 'OK':
                        // Activate content card on Enter/OK
                        if (activeElement.classList.contains('content-card')) {
                            e.preventDefault();
                            activeElement.click();
                            handled = true;
                    ...
                    case 'Backspace':
                    case 'Back':
                        // Handle back button for modals and viewer
                        const viewerPage = document.getElementById('viewer-page');
                        if (viewerPage && viewerPage.classList.contains('active')) {
                            e.preventDefault();
            ...
            // Handle content card keyboard activation
            document.addEventListener('click', updateFocusableElements);
            
            // Initial focus on first content card if no element is focused
            setTimeout(() => {
                updateFocusableElements();
                if (document.activeElement === document.body && focusableElements.length > 0) {
                    // Find first content card or focusable element
                    const firstCard = focusableElements.find(el => el.classList.contains('content-card'));
                    if (firstCard) {
                        firstCard.focus();
                    }
                }
